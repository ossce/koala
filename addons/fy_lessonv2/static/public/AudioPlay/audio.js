...
function initAudioEvent() {
	...
	if(audio != null){
		...
		audio.oncanplay = function(){
			document.getElementById('audioDuration').innerHTML = transTime(audio.duration);
		}
	}
    ...
    audioPlayer.addEventListener('click', function () {
        ...
        if (audio.paused) {
            // 开始播放当前点击的音频
            audio.play();
            audioPlayer.src = '../addons/fy_lessonv2/static/public/AudioPlay/pause.png?v=1';
			$(".audio-bg-img").addClass("playing");
			$("#is_playing").val(1);
        } else {
            audio.pause();
            audioPlayer.src = '../addons/fy_lessonv2/static/public/AudioPlay/play.png?v=1';
			$(".audio-bg-img").removeClass("playing");
			$("#is_playing").val(0);
        }
    }, false);
...
function updateProgress(audio) {
	...
	document.getElementById('current-ptime').value = parseInt(audio.currentTime);
	return '222';
}
...
function audioEnded() {
    ...
    document.getElementById('audioPlayer').src = '../addons/fy_lessonv2/static/public/AudioPlay/play.png?v=1';
}
