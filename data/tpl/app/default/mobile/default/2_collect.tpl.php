...
<ul class="tab_wrap bg-eee">
	<li class="tab_item <?php  if($ctype==1) { ?>tab_item_on<?php  } ?>">
	...
	<li class="tab_item <?php  if($ctype==2) { ?>tab_item_on<?php  } ?>">
...
<?php  } else if($ctype==2) { ?>
<link href="<?php echo MODULE_URL;?>static/mobile/<?php  echo $template;?>/css/teacherlist.css?v=<?php  echo $versions;?>" rel="stylesheet" />
