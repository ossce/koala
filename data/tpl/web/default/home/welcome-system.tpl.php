		...
		<div class="col-sm-6"> -->
			<div class="panle we7-panel ">
				<div class="panel-heading">
					<h4>商城统计</h4>
					<a href="<?php  echo url('home/welcome/ext', array('module_name' => 'store'))?>" class="more">去商城</a>
				</div>
				<div clss="panel-body">
					<div class="shop-statistics">
						<div class="order">
							<div class="num">
								<a href="<?php  echo url('site/entry/orders', array('module_name' => 'store', 'redirect' => 1))?>"><span class="new"><?php  echo $statistics_order['today']['total_orders'];?></span><span class="old"><?php  echo $statistics_order['yestoday']['total_orders'];?></span></a>
							</div>
							<div class="title">今日/昨日新增订单</div>
						</div>
						<div  class="income">
							<div class="num">
								<a href="<?php  echo url('site/entry/payments', array('module_name' => 'store', 'redirect' => 1))?>"><span class="money-icon">￥</span>
					...
					<div class="update-statistics">
						...
						<div class="content">
							...
							<div class="">
								...
								<a target="_blank" ng-if="!upgrade_show" href="http://cha.pingouxls.com" class="btn btn-default">检测新版本</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="panel-body">
			<div class="environment-statistics">
				...
				<div class="content">
					...
					<div class="title"  style="margin-bottom: 10px;">使用过程中，如有什么问题，可联系技术解决。</div>
					<div class="title"  style="margin-bottom: 20px;">----RubySn0w</div>

				<div class="action">
	
					<a  target="_blank" href="http://cha.pingouxls.com" class="btn btn-default">技术支持</a>
