...
<div class="module-welcome welcome-container clearfix" id="js-module-welcome" ng-controller="userModuleWelcomeCtrl" ng-cloak>
	...
	<div class="panel we7-panel">
		<div class="panel-heading">
			<h4>功能快捷入口</h4>
			<a ng-if="account_info.current_user_role != 'clerk'" href="<?php  echo url('module/shortcut', array('module_name' => $module_name, 'uniacid' => $uniacid))?>" class="more" >管理快捷入口</a>
		</div>
		<div class="panel-body "> 
	...
	<div class="panel we7-panel" ng-if="account_info.current_user_role != 'clerk'">
		<div class="panel-heading">
			<h4>应用操作员</h4>
			<a href="<?php  echo url('module/permission', array('module_name' => $module_name))?>" class="more" ng-if="user_permissions"> 查看更多</a>
			<a href="<?php  echo url('module/permission/post', array('module_name' => $module_name))?>" target="_blank" class="more" ng-if="user_permissions"> 添加操作员</a>
		</div>
		<div class="panel-body">
...
<script>
	angular.module('moduleApp').value('config', {
		...
		'links' : {
			...
			'shortcut' : "<?php  echo url('module/shortcut/display', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
			'get_module_info_url' : "<?php  echo url('module/welcome/get_module_info', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
			'get_module_replies_url' : "<?php  echo url('module/welcome/get_module_replies', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
			'get_module_accounts_url' : "<?php  echo url('module/welcome/get_module_accounts', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
			'get_module_covers_url' : "<?php  echo url('module/welcome/get_module_covers', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
			'module_permission_url' : "<?php  echo url('module/permission/display', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
			'change_direct_enter_status': "<?php  echo url('module/welcome/change_enter_status', array('module_name' => $module_name, 'uniacid' => $uniacid))?>",
		}
	});
