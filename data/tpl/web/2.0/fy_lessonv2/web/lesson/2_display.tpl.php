	...
	<div class="panel panel-info">
        ...
        <div class="panel-body">
            <form action="./index.php" method="get" class="form-horizontal" role="form">
				...
				<?php  if(($lesson_attribute['attribute1']) || ($lesson_attribute['attribute2'])) { ?>
				<div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-2 col-lg-2">
                        <select name="vip_id" class="form-control">
							...
							<?php  } } ?>
							<option value="-1" <?php  if($_GPC['vip_id']=='-1') { ?>selected<?php  } ?>>不支持VIP等级</option>
                        </select>
                    </div>
					<div class="col-sm-3 col-lg-3">
						...
						<ul class="pull-down-ul file-upload">
							...
							<li class="pull-down-ul__item">
								<a href="<?php echo MODULE_URL;?>static/web/xls/LessonTpl_v2.xls" download="LessonTpl_v2.xls">下载课程模板</a>
							</li>
						</ul>
		...
		<div class="panel panel-default">
			<ul class="page-nav page-nav-tabs" style="background:none;float: left;margin-left: 0px;padding-left: 0px;border-bottom:1px #c5d0dc solid;">
				...
				<li style="float:right;">
					<a style="font-weight:bold;color:#d9534f;">课程总数：<?php  echo $total;?></a>
				</li>
			</ul>
			<div class="panel-body">
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td style="word-break:break-all;">[ID:<?php  echo $parent['id'];?>] <?php  if($parent['lesson_type']==3) { ?><img src="<?php echo MODULE_URL;?>static/mobile/<?php  echo $template;?>/images/icon-live.png" height="18"><?php  } ?><?php  echo $parent['bookname'];?></td>
							<td style="text-align:center;"><span class="label label-info"><?php  echo $parent['category']['name'];?></span><br/><?php  echo $parent['teacher'];?></td>
							...
							<td style="text-align:center;">
								<div class="btn-group btn-group-sm">
									...
									<ul class="dropdown-menu dropdown-menu-left" role="menu" style="z-index:99999">
										...
										<?php  } else { ?>
										<li><a href="./index.php?c=site&a=entry&op=postlesson&id=<?php  echo $parent['id'];?>&do=lesson&module_name=fy_lessonv2_plugin_live&refurl=<?php  echo urlencode($_W['siteurl']);?>"><i class="fa fa-edit"></i> 编辑课程</a></li>
										<?php  } ?>
										...
										<li><a href="./index.php?c=site&a=entry&op=transform&id=<?php  echo $parent['id'];?>&do=lesson&module_name=fy_lessonv2_plugin_live" onclick="return confirm('确认转为直播课程？');return false;"><i class="fa fa-exchange"></i> 转为直播课</a></li>
										...
										<?php  if($parent['lesson_type']==3) { ?>
										<li><a href="./index.php?c=site&a=entry&op=auditContent&id=<?php  echo $parent['id'];?>&do=lesson&module_name=fy_lessonv2_plugin_live"><i class="fa fa-check-square-o"></i> 审核聊天内容</a></li>
										<li><a href="./index.php?c=site&a=entry&op=transform&id=<?php  echo $parent['id'];?>&do=lesson&module_name=fy_lessonv2_plugin_live" onclick="return confirm('确认转为录播课程？');return false;"><i class="fa fa-exchange"></i> 转为录播课</a></li>
										<li><a href="./index.php?c=site&a=entry&op=destroyGroup&id=<?php  echo $parent['id'];?>&do=lesson&module_name=fy_lessonv2_plugin_live&refurl=<?php  echo urlencode($_W['siteurl']);?>"><i class="fa fa-recycle"></i> 重置聊天室</a></li>
										<?php  } ?>
								...
								<div class="form-controls col-sm-9">
									...
									<?php  if(is_array($level_list)) { foreach($level_list as $item) { ?>
										<label class="radio-inline pad-l-5">
											<input type="checkbox" name="vipview[]" value="<?php  echo $item['id'];?>" />
											<span class="label-middle"><?php  echo $item['level_name'];?></span>
										</label>
									<?php  } } ?>
								</div>
							</div>
