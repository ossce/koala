...
$config['db']['master']['username'] = 'wk_510zxc_co';
$config['db']['master']['password'] = 'wk_510zxc_co';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'wk_510zxc_co';
...
$config['setting']['authkey'] = '8bd078bf';
